...
import com.espy.onecallsys.api.models.shops.DeliveryShop
import com.espy.onecallsys.databinding.FragmentDeliveryShopsBinding
import com.espy.onecallsys.ui.base.BaseFragmentWithBinding
import com.espy.onecallsys.ui.shops.adapter.DeliveryShopListAdapter
import java.util.*
...
class DeliveryShopsFragment:
    ...
    private var searchList: List<DeliveryShop> = listOf()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        shopsViewModel.getDeliveryShopsList(selectedDateFrom, selectedDateTo)
    ...
    private fun setObservers(){
        shopsViewModel.deliveryShopsList.observe(viewLifecycleOwner) {
    ...
    private fun loadOrders(list: List<DeliveryShop>){
    ...
    private fun setAutoCompleteSearch(){
        ...
        binding.srch.apply {
            ...
            setOnItemClickListener { parent, _, position, _ ->
                ...
                searchList.find {
                    it.shopid == (parent.getItemAtPosition(position) as DeliveryShop).shopid
                }?.run {
                    val tempList = arrayListOf<DeliveryShop>()
                    tempList.add(this)
