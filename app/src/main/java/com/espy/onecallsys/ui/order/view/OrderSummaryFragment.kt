...
import com.espy.onecallsys.databinding.FragmentOrderSummaryBinding
...
import com.espy.onecallsys.ui.order.adapter.OrderSummaryAdapter
    ...
    private fun showUploadWarning() {
        AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("Yes") { dialog, _ ->
                ...
                orderViewModel.uploadOrder(discountAmount,binding?.edtRemarks.text.toString())
                binding.apply {
