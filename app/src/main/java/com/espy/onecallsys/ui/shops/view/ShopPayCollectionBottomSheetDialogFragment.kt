...
import com.espy.onecallsys.databinding.FragmentShopPayCollectionBottomSheetBinding
    ...
    private fun showDatePickerDialog(dateType: Int){
        ...
        val datePicker = DatePickerDialog(requireActivity(), { _, year, monthOfYear, dayOfMonth ->
            ...
            if (dateType == 1) {
                ...
                binding.etChecqDate.text = SimpleDateFormat(DATE_FORMAT_SERVER, Locale.US).format(c.time)
