...
import com.espy.onecallsys.api.models.shops.Route
import com.espy.onecallsys.app.AppPermission
import com.espy.onecallsys.databinding.FragmentAddShopBinding
import com.espy.onecallsys.extensions.handlePermission
import com.espy.onecallsys.extensions.requestPermission
...
class AddShopFragment:
    ...
    private fun showUploadWarning(newShopData: NewShopData) {
        AlertDialog.Builder(requireContext())
            .setMessage("Confirm submit new shop details?")
