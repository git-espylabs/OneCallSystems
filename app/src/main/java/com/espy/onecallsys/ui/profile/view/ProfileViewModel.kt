...
import com.espy.onecallsys.api.models.login.LeaveRequest
import com.espy.onecallsys.repository.ProfileRepository
import com.espy.onecallsys.api.models.login.LoginResponse
import com.espy.onecallsys.app.InstanceManager
...
class ProfileViewModel : BaseViewModel() {
    ...
    private val _loginsResponse: MutableLiveData<com.espy.onecallsys.api.Result<LoginResponse>> = MutableLiveData()
    val loginsResponse: LiveData<com.espy.onecallsys.api.Result<LoginResponse>>
    get() = _loginsResponse
    ...
    private val _expenseTypesList: MutableLiveData<com.espy.onecallsys.api.Result<List<ExpenseType>>> = MutableLiveData()
    val expenseTypesList: LiveData<com.espy.onecallsys.api.Result<List<ExpenseType>>>
