package com.espy.onecallsys.ui.order.view
...
import com.espy.onecallsys.domain.toOrderRequestTrans
...
import com.espy.onecallsys.api.models.products.ProductStockRequest
import com.espy.onecallsys.domain.toImageSlide
import com.espy.onecallsys.domain.toOrderEntity
...
class OrderViewModel : BaseViewModel() {
   ...
   var _slideImages: MutableLiveData<List<ImageSlide>> = MutableLiveData()
    ...
    fun uploadOrder(discountAmount: Double,remarks:String?){
