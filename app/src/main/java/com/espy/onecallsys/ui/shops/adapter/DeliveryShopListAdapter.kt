...
class DeliveryShopListAdapter internal constructor(private val context: Context, private val mData: List<DeliveryShop>, val clickHandler: (shop: DeliveryShop, navigate: Boolean) -> Unit) : RecyclerView.Adapter<DeliveryShopListAdapter.ViewHolder>()  {
